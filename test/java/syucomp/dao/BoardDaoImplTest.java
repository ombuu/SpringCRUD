...
import syucomp.domain.BoardDto;
import syucomp.domain.SearchCondition;
...
public class BoardDaoImplTest {
    ...
    public void searchSelectPageTest()throws Exception{
        boardDao.deleteAll();
        for (int i = 1; i < 21; i++){
            BoardDto boardDto = new BoardDto("title"+i,"슈슈슈슈슝슈슈슝","비은정"+i);
        ...
        sc = new SearchCondition(1,10,"비은정2","W"); // 비은정2%
    ...
    public void searchResultCntTest()throws Exception{
        boardDao.deleteAll();
        for (int i = 1; i < 21; i++){
            BoardDto boardDto = new BoardDto("title"+i,"슈슈슈슈슛시발러마슈슈슉","비은정"+i);
            boardDao.insert(boardDto);
